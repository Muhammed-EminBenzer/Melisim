...
// ===================================================
const quotes = [
  "Seninle her anım cennete gibi.",
  "Güldüğünde dünyam duruyor.",
  "bunu görünce NE GÜZELİZ BEE diyorum.",
  "çok güzel çok şirin hatunummm.",
  "eşşek oğlu eşşek ne işin var burda.",
  "bu poz vermediğimiz an aslında çekildikten sonrası , hala biraz ciddiyim hahaha.",
  "Benim dünyalar güzeli sevgilim.",
  "Yüzünden gülümseme hiç gitmesin bebeğim.",
  "Seninle olmak her şeyi kolaylaştırıyor.",
  "asi ve serseri bi poz",
  "bende çeteye üyeyim artık.",
  "Sıpa bak yine geldi , her neyse oğluşumuzla birlikte.",
  "güzelim bebeğimin günü",
  "sıkıntı var mı bakarken yakalanmısız.",
  "senle tartışınca böyle düşünüyorum.",
  "şu bakışşş.",
  "gülüşün delirtiyo beni.",
  "esoyla imtihana geç gelip güzel bir puan alıyorum.",
  "Asalet.",
  "Harry Potter date",
  "Her baktığımda yeniden gülümsüyorum.",
  "Bu kadar mutlu olunur muymuş?",
  "Anlar bu kadar güzel olabilir.",
  "hep benimxin hatunum."
];
